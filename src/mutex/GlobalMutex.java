...
import servent.message.HandleLockMessage;
...
public final class GlobalMutex{
	...
	public static void sendTokenForward() {
		if( (Integer)AppConfig.chordState.getNextNodePort() != null &&
				AppConfig.chordState.getNextNodeIp() != null) {
			MessageUtil.sendMessage(new HandleLockMessage(AppConfig.myServentInfo.getListenerPort(),
